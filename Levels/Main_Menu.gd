...
@onready var start_button_pressed := preload("res://Art/pixelart/overlay/PlaySelected.png")
@onready var start_button_not_pressed := preload("res://Art/pixelart/overlay/PlayNotSelected.png")
@onready var choose_button_pressed := preload("res://Art/pixelart/overlay/ChooseSelected.png")
@onready var choose_button_not_pressed := preload("res://Art/pixelart/overlay/ChooseNotSelected.png")
