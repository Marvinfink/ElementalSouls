...
@onready var menu_button_pressed := preload("res://Art/mystic_woods_free_2.1/overlay/PlaySelected.png")
@onready var menu_button_not_pressed := preload("res://Art/mystic_woods_free_2.1/overlay/PlayNotSelected.png")
